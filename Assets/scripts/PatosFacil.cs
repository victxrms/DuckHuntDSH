...
public class PatosFacil : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        velocidad_y = (float)random.Next(1, 2) / 60; // Genera una velocidad aleatoria en el eje Y
        velocidad_z = (float)random.Next(1, 2) / 60; // Genera una velocidad aleatoria en el eje Z
