...
public class arma : MonoBehaviour
{
    ...
    public List<Image> balasCargador; // Lista para las im�genes de las balas del cargador
    public int indiceBalaCargadorActual = 0; // �ndice de la bala actual en el cargador
